...
class RepoVersionTests(unittest.TestCase):
    """Test that the `rules_ansible` versions match for WORKSPACE and bzlmod."""
    ...
    def test_versions(self) -> None:
        ...
        version_bzl = rlocation(runfiles, "rules_ansible/version.bzl")
        ...
        module_bazel = rlocation(runfiles, "rules_ansible/MODULE.bazel")
        module_version = re.findall(
            r'module\(\n\s+name = "rules_ansible",\n\s+version = "([\d\w\.]+)",\n\)',
